...
- Generera stereoljud med mittfrekvens 220 Hz. För exempelvis 6 Hz spelas 217 Hz i vänster öra och 223 Hz i höger. Kontroll har 220 Hz i båda öronen. Använd samma amplitud och mjuka övergångar för alla åtgärder. Rekommendera stereohörlurar och erbjud ett manuellt test som loopar `audio/stereo_test.wav` tills användaren stoppar det, utan att blockera sessionen utifrån upptäckt ljudutgång.
